    ...
    <div id="content">
        <div class="card">
            ...
            <div class="card-body">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <div class="btn-group" role="group" aria-label="Basic example">
                                        ...
                                        <form action="{{ url('/evidencias/'.$evidencia->id) }}" method="POST">
                                            {{csrf_field()}}
                                            {{ method_field('DELETE') }}
                ...
                @endif
                <button class="btn btn-secondary" title="Atras" onclick="window.location='{{ url('/formulario/') }}';">Regresar</button>
            </div>
        </div>
    </div>
        ...
        <div class="modal-dialog" role="document">
            ...
            <div class="modal-body mx-3">
                <div class="md-form center">
                    <form action="/evidencias/store" method="POST" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        <div class="centered">
